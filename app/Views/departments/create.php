...
<head>
    ...
    <title>Create Department - DMS</title>
        ...
        <div class="row">
            ...
            <div class="p-0">
                <div class="main-content">
                    <!-- Header -->
                    <?= view('common/header', [
                        'pageTitle' => '<i class="fas fa-building me-2"></i>Create New Department',
                        'pageDescription' => 'Add a new department to the organization'
                    ]) ?>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="description" class="form-control"
                                                value="<?= old('description') ?>" placeholder="Enter department description">
                                        </div>
