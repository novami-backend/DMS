...
<head>
    ...
    <title>Edit Permission - DMS</title>
        ...
        <div class="row">
            ...
            <div class="p-0">
                <div class="main-content">
                    <!-- Header -->
                    <?= view('common/header', [
                        'pageTitle' => '<i class="fas fa-key me-2"></i>Edit Permission',
                        'pageDescription' => 'Update permission details'
                    ]) ?>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form method="post" action="<?= base_url('/permissions/update/' . $permission['id']) ?>">
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="permission_key" class="form-control" 
                                                   value="<?= old('permission_key', $permission['permission_key']) ?>" required>
                                        </div>
