        ...
        <div class="row">
            ...
            <div class="p-0">
                <div class="main-content">
                    <!-- Header -->
                    <?= view('common/header', [
                        'pageTitle' => '<i class="fas fa-user-tag me-2"></i>Create New Role',
                        'pageDescription' => 'Define a new role with specific permissions'
                    ]) ?>
                        ...
                        <div class="card-body">
                            <form method="post" action="<?= base_url('roles/store') ?>">
                                    ...
                                    <div class="mb-4 col-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="role_name" class="form-control"
                                                value="" placeholder="Enter role name" required>
                                        </div>
                                    ...
                                    <div class="mb-4 col-8">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <textarea name="description" class="form-control"
                                                rows="1" placeholder="Enter role description" required></textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <!-- Document Management -->
                                    <h6 class="mt-3">Document Management</h6>
                                    <div class="row">
                                        <?php foreach ($permissions as $permission): ?>
                                    ...
                                    <h6 class="mt-3">Document Type Management</h6>
                                    <div class="row">
                                        <?php foreach ($permissions as $permission): ?>
                                    ...
                                    <h6 class="mt-3">Department Management</h6>
                                    <div class="row">
                                        <?php foreach ($permissions as $permission): ?>
                                    ...
                                    <!-- System -->
                                    <?php /* ?>
                                    <h6 class="mt-3">System</h6>
                                    <div class="row">
                                        <?php foreach ($permissions as $permission): ?>
                                            <?php if (!preg_match('/^(user_|role_|permission_)/', $permission['permission_key'])): ?>
                                                <div class="col-md-3 mb-2">
                                                    <div class="card permission-card">
                                                        <div class="card-body py-2">
                                                            <div class="form-check">
